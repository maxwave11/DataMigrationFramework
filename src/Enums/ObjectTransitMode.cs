...
namespace XQ.DataMigration.Enums
{
    ...
    {
        /// <summary>
        /// Transit both kind of objects (no matter whether they exist in target system). If object with appropriate
        ...
        /// <summary>
        /// Transit only existed objects which are already exist in the target system. In this case 
