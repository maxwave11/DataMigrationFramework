...
namespace XQ.DataMigration.Enums
{
    ...
    {
        /// <summary>
        /// TransitInternal both kind of objects (no matter whether they exist in target system). If object with appropriate
        ...
        /// <summary>
        /// TransitInternal only new objects which are not exist in target system yet. If object already exists in target
        ...
        /// <summary>
        /// TransitInternal only existed objects which are already exist in the target system. In this case 
